...
public readonly struct HFSMasterDirectoryBlock
{
    ...
    /// <summary>
    /// Gets the number of files in the root directory.
    /// </summary>
    public ushort FileCount { get; }

    /// <summary>
    /// Gets the volume bitmap block number.
    /// </summary>
    public ushort VolumeBitmapBlockNumber { get; }

    /// <summary>
    /// Gets the start of the next allocation search.
    /// </summary>
    public ushort NextAllocationSearch { get; }

    /// <summary>
    /// Gets the number of allocation blocks.
    /// </summary>
    public ushort NumberOfAllocationBlocks { get; }

    /// <summary>
    /// Gets the allocation block size in bytes.
    /// </summary>
    public uint AllocationBlockSize { get; }

    /// <summary>
    /// Gets the default clump size.
    /// </summary>
    public uint DefaultClumpSize { get; }

    /// <summary>
    /// Gets the extents start block number.
    /// </summary>
    public ushort ExtentsStartBlockNumber { get; }

    /// <summary>
    /// Gets the next available catalog node identifier (CNID).
    /// </summary>
    public uint NextAvailableCatalogNodeID { get; }

    /// <summary>
    /// Gets the number of unused allocation blocks.
    /// </summary>
    ...
    /// <summary>
    /// Gets the volume write count.
    /// </summary>
    public uint VolumeWriteCount { get; }

    /// <summary>
    /// Gets the clump size for the extents overflow file.
    /// </summary>
    public uint ClumpSizeForExtentsOverflowFile { get; }

    /// <summary>
    /// Gets the clump size for the catalog file.
    /// </summary>
    public uint ClumpSizeForCatalogFile { get; }

    /// <summary>
    /// Gets the number of subdirectories in the root directory.
    /// </summary>
    ...
    /// <summary>
    /// Gets the total number of directories (excluding the root).
    /// </summary>
    ...
    /// <summary>
    /// Gets the embedded volume extent descriptor.
    /// </summary>
    public uint EmbeddedVolumeExtentDescriptor { get; }

    /// <summary>
    /// Gets the extents overflow file size.
    /// </summary>
